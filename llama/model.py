...
class ModelArgs:
    ...
    n_layers: int = 32
    n_heads: int = 32
    n_kv_heads: Optional[int] = None  # Group-Query Attention head number, groups = n_rep = n_heads // n_kv_heads
...
class Attention(nn.Module):
    ...
    def forward(
        ...
        # (bs, n_local_heads, seqlen, head_dim) @ (bs, n_local_heads, head_dim, cache_len + seqlen) = (bs, n_local_heads, seqlen, cache_len + seqlen)
